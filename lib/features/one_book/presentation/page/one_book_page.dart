...
class OneBookPage extends StatefulWidget {
  ...
  const OneBookPage({super.key, required this.bookId});
          ...
          if (state is BookDetailsSuccess) {
            ...
            return InBackgroundPage(
              ...
              onBackPressed: ()  {
                ...
                // final  classifId = prefs.getInt("classifId");
                // print("clllllllllla:$classifId");
                //  prefs.remove("classifId");
                // GoRouter.of(context).push('/BooksPage', extra: classifId);
              },
              child: SizedBox(
                height: context.h(88.6),
                child: ListView(
...
class ChooseStudyWayArgs {
  ...
  ChooseStudyWayArgs({required this.chapterId, required this.authorName});
}
